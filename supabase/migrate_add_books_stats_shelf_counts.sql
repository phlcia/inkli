-- Add shelf counts to books_stats and update aggregation trigger

ALTER TABLE public.books_stats
  ADD COLUMN IF NOT EXISTS shelf_count_read INTEGER DEFAULT 0,
  ADD COLUMN IF NOT EXISTS shelf_count_currently_reading INTEGER DEFAULT 0,
  ADD COLUMN IF NOT EXISTS shelf_count_want_to_read INTEGER DEFAULT 0;
